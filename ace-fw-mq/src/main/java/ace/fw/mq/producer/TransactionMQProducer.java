 ...
 */
public interface TransactionMQProducer<MessageBody> {
    /**
     * 同步发送事务MQ
     *
     * @param message 事务消息
     ...
     */
    GenericResponseExt<TransactionStatusEnum> send(final TransactionMessage<MessageBody> message, final Object args);
     ...
     * @return
     */
    TransactionMQChecker<MessageBody> getListener();
}
