...
//        return ShardingDBAlgorithms.dataBaseHashCoding;
//    }
//
...
//            throw new BusinessException("通过分库负载均衡一致性算法获取真实节点数时，identity 不能为null 或空字符串!");
//        }
...
//        String locatorStr = Integer.toString(ShardingDBAlgorithms.getRealNode(identity), 32).toUpperCase();
